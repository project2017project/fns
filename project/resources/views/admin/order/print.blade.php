    ...
    <div class="invoice-wrap">
            <div class="invoice__title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="invoice__details text-right">
                            <h4>FNS Private Limited</h4>
                           <p><strong>Address : </strong>313, 3RD Floor , ITL Twin Tower, B-09, Netaji Subhash Place, Pitampura, New Delhi, Delhi 110034</p>

                           <p><strong>Email : </strong> Hello@fns.co.in </p>
                           <p><strong> Gst No : </strong>FFGHGG45544</p>
                        </div>
                    </div>
                </div>
            </div>
