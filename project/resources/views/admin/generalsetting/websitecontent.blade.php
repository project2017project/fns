                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="row justify-content-center">
                               ...
                               <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="deal-banner-wrap">
                                     <img src="{{asset('assets/images/'.$gs->deal_banner)}}" style="max-height: 80px; margin-bottom: 15px;">
                                      <input type="file" name="deal_banner" class="input-field">
                                    </div>
                                </div>
                              </div>
                              ...
                              <div class="col-lg-6">
                                  <div>
                                   ...
                                   <input class="input-field" name="deal_link" value="{{$gs->deal_link}}">
                                  </div>
                              </div>
                            </div>
                              ...
                              <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="deal-banner-wrap">
                                      <img src="{{asset('assets/images/'.$gs->gift_banner)}}" style="max-height: 80px; margin-bottom: 15px;">
                                      <input type="file" name="gift_banner" class="input-field">
                                    </div>
                                </div>
                              </div>
                              ...
                              <div class="col-lg-6">
                                  <div >
                                  <input class="input-field" name="gift_link" value="{{$gs->gift_link}}">
                                  </div>
                              </div>
                            </div>
