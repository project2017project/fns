...
<div class="content-area">
    <div class="mr-breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="product-description">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Slug Name') }}* </h4>
                                                    <p class="sub-heading">{{ __('(In Any Language)') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="text" class="input-field"
                                                placeholder="{{ __('Enter Slug Name') }}" name="slug" value="{{ $data->slug }}">
                                            </div>
                                        </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="left-area">
                                                <h4 class="heading">{{ __('Set of') }}</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <select id="set" name="set_id">
                                                <option value="">{{ __('Select Set of') }}</option>
                                                @php
                                                  $set = DB::table('sets')->get();
                                              @endphp
                                                @foreach($set as $se)
                                               <option value="{{$se->id}}" {{$se->id == $data->set_id ? "selected":""}} >{{$se->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <select id="color" name="color_id">
                                              ...
                                              @endphp
                                               ...
                                               <option value="{{$col->id}}" {{$col->id == $data->color_id ? "selected":""}} >{{$col->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <select id="color" name="size_id">
                                                <option value="">{{ __('Select Size') }}</option>
                                                @php
                                                  $size = DB::table('sizes')->get();
                                              @endphp
                                                @foreach($size as $siz)
                                                <option value="{{$siz->id}}" {{$siz->id == $data->size_id ? "selected":""}} >{{$siz->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="{{ !empty($data->size) ? 'showbox' : '' }}" id="stckprod">
                                    <div class="row check-hide-product">
        ...
        <div class="row {{ !empty($data->size) ? 'd-none' : '' }}" id="default_stock" class="check-hide-product">
            <div class="col-lg-12">
                <div class="left-area">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <ul class="list">
                <li>
                    <input class="checkclickc2" name="variation_check" type="checkbox"
                    id="variation" value="1" {{ !empty($data->variation) ? 'checked' : '' }}>
                    <label for="variation">{{ __('Allow Product Variation') }}</label>
                </li>
            </ul>
        </div>
    </div>

    <div class="{{ !empty($data->variation) ? '' : 'showbox' }}">
       @if (!empty($data->variation))
       <div class="row">

        <div class="col-lg-12">
            <div class="select-input-variation" id="variation-section">
                @foreach (array_unique(explode(',', $data->variation)) as $va)
                <div class="variation-area">
                    <span class="remove variation-remove"><i
                        class="fas fa-times"></i></span>
                        <input type="text" name="variation[]"
                        class="input-field tvariation"
                        placeholder="{{ __('Enter Variation Product Code') }}" value="{{ $va }}" required="">

                    </div>
                    @endforeach
                </div>
                <a href="javascript:;" id="variation-btn" class="add-more mt-4 mb-3"><i
                    class="fas fa-plus"></i>{{ __('Add More Variation') }} </a>
                </div>
            </div>
            @else
                    ...
                    <div class="select-input-variation" id="variation-section">
                        ...
                        <div class="variation-area">
                            <span class="remove variation-remove"><i
                                ...
                                <input type="text" name="variation[]"
                                class="input-field tvariation"
                                placeholder="{{ __('Enter Variation Product Code') }}">
 ...
 <div class="row">
        ...
        <div class="col-lg-12">
            <ul class="list">
                <li>
                    <input class="checkclickc3" name="cross_selling_check" type="checkbox"
                    id="cross_selling" value="1" {{ !empty($data->cross_selling) ? 'checked' : '' }}>
                    <label for="cross_selling">{{ __('Allow Product Cross Selling') }}</label>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="{{ !empty($data->cross_selling) ? '' : 'showbox' }}">
       @if (!empty($data->cross_selling))
       <div class="row">

        <div class="col-lg-12">
            <div class="select-input-cross_selling" id="cross_selling_section">
                @foreach (array_unique(explode(',', $data->cross_selling)) as $va)
                <div class="cross_selling_area">
                    <span class="remove cross_selling_remove"><i
                        class="fas fa-times"></i></span>
                        <input type="text" name="cross_selling[]"
                        class="input-field tcross_selling"
                        placeholder="{{ __('Enter Cross Selling Product Code') }}" value="{{ $va }}" required="">

                    </div>
                    @endforeach
                </div>
                <a href="javascript:;" id="cross_selling_btn" class="add-more mt-4 mb-3"><i
                    class="fas fa-plus"></i>{{ __('Add More Cross Selling') }} </a>
                </div>
            </div>
            @else
                    ...
                    <div class="select-input-cross_selling" id="cross_selling_section">
                        ...
                        <div class="cross_selling_area">
                            <span class="remove cross_selling_remove"><i
                                ...
                                <input type="text" name="cross_selling[]"
                                class="input-field tcross_selling"
                                placeholder="{{ __('Enter Cross Selling Product Code') }}">
        ...
        <div class="row">
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="left-area">
                        <h4 class="heading">{{ __('Watch It') }}*</h4>
                        <p class="sub-heading">{{ __('(Optional)') }}</p>
                    </div>
                </div>
                <div class="col-lg-12">
                    <input name="watchit" type="file" class="input-field"
                    placeholder="Watch It" value="{{ $data->watchit }}">
                </div>
            </div>
