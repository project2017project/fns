                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="input-field"
                                                    placeholder="{{ __('Enter Slug Name') }}" name="slug">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="input-field"
                                                    placeholder="{{ __('Enter Product Weight') }}" name="weight" value="0">
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="select-input-variation" id="variation-section">
                                                        <div class="variation-area">
                                                            ...
                                                            <input type="text" name="variation[]"
                                                                ...
                                                                placeholder="{{ __('Enter Product Variation') }}">
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclickc3" name="cross_selling_check" type="checkbox"
                                                            id="cross_selling" value="1">
                                                        <label for="cross_selling">{{ __('Allow Cross Selling') }}</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="select-input-cross_selling" id="cross_selling_section">
                                                        <div class="cross_selling_area">
                                                            ...
                                                            <input type="text" name="cross_selling[]"
                                                                ...
                                                                placeholder="{{ __('Enter Cross Selling Code') }}">
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" name="watchit" class="input-field"
                                                    placeholder="{{ __('Watch It') }}">
                                            </div>
                                        </div>
