    <li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-orders-all') }}?status=ondelivery"> {{ __('Shipping Order') }}</a>
            </li>
            <li>
                <a href="{{ route('admin-orders-all') }}?status=refund-request"> {{ __('Refund Request Orders') }}</a>
            </li>
            <li>
                <a href="{{ route('admin-orders-all') }}?status=refunded"> {{ __('Refunded Orders') }}</a>
            </li>
        </ul>
    </li>
    <li>
        <a href="#ecatalougue1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-flag"></i>{{ __('Manage E Catalogue') }}
        </a>
        <ul class="collapse list-unstyled" id="ecatalougue1" data-parent="#accordion">
            <li>
                <a href="{{ route('admin.ecatalogue.list') }}"><span>{{ __('E-Catalogue') }}</span></a>
            </li>
        </ul>
    </li>
 ...
 <!--    <li>
  ...
  <!--   <li>
   ...
   <!--  <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-set-index') }}"><span>{{ __('Manage Set Of') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-size-index') }}"><span>{{ __('Manage Size') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-color-index') }}"><span>{{ __('Manage Color') }}</span></a>
            </li>
            <!-- <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-deal-index') }}"><span>{{ __('Deals') }}</span></a>
            </li>
   ...
   <!--  <li>
    ...
    <li>
        <a href="{{ route('admin-webpushnotification-index') }}"><i class="fas fa-bell"></i>Web Push Notification</a>
    </li>
    ...
    <!-- <li>
        <a href="{{ route('admin-addon-index') }}" class=" wave-effect"><i
                class="fas fa-list-alt"></i>{{ __('Addon Manager') }}</a>
    </li> -->
  ...
  <!--   <li>
        ...
        <ul class="collapse list-unstyled" id="sactive" data-parent="#accordion">
            ...
            @if ($gs->demo_content == 0)
                <li><a href="{{ route('admin-remove-democontent') }}" id="demo_delete">
                        {{ __('Remove Demo Content') }}</a></li>
            @endif
