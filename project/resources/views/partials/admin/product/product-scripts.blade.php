<script>
    ...
    (function($) {
        ...
        $(document).ready(function() {
            ...
            // Check Clickc :)
            $(".checkclickc2").on( "change", function() {
                if(this.checked){
                    $('.tvariation').prop('required',true);
                 $(this).parent().parent().parent().parent().next().removeClass('showbox');  
                }
                else{
                 $('.tvariation').prop('required',false);
                 $(this).parent().parent().parent().parent().next().addClass('showbox');   
                }
            });
            // Check Clickc Ends :)
            ...
            // Check Clickc :)
            $(".checkclickc3").on( "change", function() {
                if(this.checked){
                    $('.tcross_selling').prop('required',true);
                 $(this).parent().parent().parent().parent().next().removeClass('showbox');  
                }
                else{
                 $('.tcross_selling').prop('required',false);
                 $(this).parent().parent().parent().parent().next().addClass('showbox');   
                }
            });
            // Check Clickc Ends :)
...
$("#variation-btn").on('click', function(){
    ...
    $("#variation-section").append(''+
                            '<div class="variation-area">'+
                                '<span class="remove variation-remove"><i class="fas fa-times"></i></span>'+
                                        '<input type="text" name="variation[]" placeholder="{{ __("Enter Product Variation Code") }}" class="input-field tvariation"/>'+
...
// variation Section Ends


// Cross Selling Section

$("#cross_selling_btn").on('click', function(){


    $("#cross_selling_section").append(''+
                            '<div class="cross_selling_area">'+
                                '<span class="remove cross_selling_remove"><i class="fas fa-times"></i></span>'+
                                        '<input type="text" name="cross_selling[]" placeholder="{{ __("Enter Product Cross Selling Code") }}" class="input-field tcross_selling"/>'+
...
$(document).on('click','.cross_selling_remove', function(){

    $(this.parentNode).remove();
    if (isEmpty($('#cross_selling_section'))) {
