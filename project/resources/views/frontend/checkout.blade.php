                           ...
                           <div class="content">
                              ...
                              <div class="billing-address">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                       <input class="form-control ship_input" type="text" name="customer_state"
                                          id="customer_state" placeholder="{{ __('State') }}">
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                       <select class="form-control" id="customer_countrys" name="customer_country" required="">
