                        ...
                        <div id="quickView" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="item carousel-item active" data-bs-slide-number="0">
                                    <img class="blur-up lazyload" data-src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:asset('assets/images/products/'.$product->photo)}}" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:asset('assets/images/products/'.$product->photo)}}" alt="image" title="" />
                                </div>
                                @foreach($product->galleries as $gal)
                                <div class="item carousel-item" data-bs-slide-number="1">
                                    <img class="blur-up lazyload" data-src="{{asset('assets/images/galleries/'.$gal->photo)}}" src="{{asset('assets/images/galleries/'.$gal->photo)}}" alt="image" title="" />
                                </div>
                                @endforeach
                            </div>
            ...
            <div class="product-info">
              ...
              {{-- REVIEW SECTION  --}}
                  ...
                  {{-- REVIEW SECTION ENDS  --}}
                   ...
                   @if( $product->sku != null )
              <div class="product-id product-info mb-2">
              ...
              <div class="pricebox">
                <div class="price">
                <span class="price product-price__sale" id="msizeprice"> {{ $product->showPrice() }}
                </span>
                  <span class="price old-price">{{ $product->showPreviousPrice() }}</span>
                </div>
              </div>
...
<div class="sort-description">
  <p>{{ $product->details }} </p></div>
              ...
              @if(!$product->emptyStock())
                ...
                <div class="inner-box">
                  <div class="cart-btn">
                    <div class="product-action product-form d-flex-wrap w-100 mb-3 clearfix">
                      ...
                      @if($product->product_type != "affiliate" && $product->type == 'Physical')
                            ...
                            <div class="quantity">
                              <div class="qtyField rounded">
                                <span class="qtyBtn plus modal-plus">
                                  <i class="icon an an-plus-l"></i>
                                </span>
                                <input class="modal-total product-form__input qty rounded-0" type="text" id="order-qty1" value="{{ $product->minimum_qty == null ? '1' : (int)$product->minimum_qty }}">
                                <input type="hidden" id="mproduct_minimum_qty" value="{{ $product->minimum_qty == null ? '0' : $product->minimum_qty }}">
                                <span class="qtyBtn minus modal-minus">
                      ...
                      <div class="add-to-cart ms-3 fl-1">
                        <a href="{{ route('affiliate.product', $product->slug) }}" target="_blank" class="btn button-cart rounded-0">
                          {{ __('Buy Now') }}
                        </a>
                      </div>
                      ...
                      <div class="add-to-cart ms-3 fl-1">
                        <a href="javascript:;" id="maddcrt" class="btn button-cart rounded-0">
                          {{ __('Add To Cart') }}
                        </a>
                      </div>

                      <div class="add-to-cart ms-3 fl-1">
                        <a id="mqaddcrt" href="javascript:;" class="btn button-cart rounded-0">
                          {{ __('Buy Now') }}
                        </a>
                      </div>
