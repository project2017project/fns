...
<html lang="en">
    <head>
        ...
        <meta name="description" content="FNS - Multivendor Ecommerce system">
        <meta name="author" content="FNS">
    	    ...
    	    @elseif(isset($productt))
                <meta name="title" content="{{ !empty($productt->meta_title) ? $productt->meta_title: $productt->name }}">
            ...
            <link rel="stylesheet" href="{{ asset('assets/front/css/fns-plugins.css') }}">
            ...
            <link rel="stylesheet" href="{{ asset('assets/front/css/fns-style.css') }}">
            <link rel="stylesheet" href="{{ asset('assets/front/css/style.css') }}">    
            <link rel="stylesheet" href="{{ asset('assets/front/css/fns-responsive.css') }}">
        ...
        @if(!empty($seo->facebook_pixel))
    		...
    		<noscript>
    			<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id={{ $seo->facebook_pixel }}&ev=PageView&noscript=1"/>
    		</noscript>
    	@endif
        @yield('css')
        
        <script src="https://fns.ourdevelopents.tech/webpushr-sw.js"></script>
        <!-- start webpushr tracking code --> 
       <script>(function(w,d, s, id) {if(typeof(w.webpushr)!=='undefined') return;w.webpushr=w.webpushr||function(){(w.webpushr.q=w.webpushr.q||[]).push(arguments)};var js, fjs = d.getElementsByTagName(s)[0];js = d.createElement(s); js.id = id;js.async=1;js.src = "https://cdn.webpushr.com/app.min.js";
        fjs.parentNode.appendChild(js);}(window,document, 'script', 'webpushr-jssdk'));
        webpushr('setup',{'key':'BA_23mwvuGXhxOyp4Wwnx0HMIYJ2fWMPZE8DpnhBAjFgKiTWN7zQYUbw-cnQQaLR1pj4nDSbhVJFFS2tHHdOfEA' });</script>
    ...
    <body class="template-index index-demo20">
        ...
        <script src="{{ asset('assets/front/js/fns-plugins.js') }}"></script>
        ...
        <script src="{{ asset('assets/front/js/vendor/fns-js.cookie.js') }}"></script>
        @yield('zoom')
        <script src="{{ asset('assets/front/js/paraxify.js') }}"></script>
        <script src="{{ asset('assets/front/js/toastr.min.js') }}"></script>
        <script src="{{ asset('assets/front/js/fns-main.js') }}"></script>
