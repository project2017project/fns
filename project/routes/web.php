...
Route::prefix('admin')->group(function () {
    Route::get('/e-catalogue', 'Admin\ECatalogueController@index')->name('admin.ecatalogue.list');
    Route::get('/e-catalogue/datatables', 'Admin\ECatalogueController@datatables')->name('admin-e-catalogue-datatables'); // JSON REQUEST
    Route::get('/e-catalogue/add', 'Admin\ECatalogueController@create')->name('admin-add-e-catalogue');
    Route::get('/e-catalogue/edit/{id}', 'Admin\ECatalogueController@edit')->name('admin-edit-e-catalogue');
    Route::delete('/e-catalogue/delete/{id}', 'Admin\ECatalogueController@destroy')->name('admin-delete-e-catalogue');

    Route::post('/e-catalogue-post', 'Admin\ECatalogueController@store')->name('admin-post-e-catalogue');
    Route::post('/e-catalogue-update/{id}', 'Admin\ECatalogueController@update')->name('admin-update-e-catalogue');
    // ------------ ADMIN LOGIN SECTION ------------
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        Route::get('/orders/create-shipment/{id}', 'Admin\OrderController@createShipment')->name('admin-order-craete-shipment');
        Route::post('/orders/post-shipment/{id}', 'Admin\OrderController@postShipment')->name('admin-post-create-shipment');
        // Order Tracking
        ...
        // Order Tracking Ends
        Route::get('download-excel-file/{type}', array('as'=>'excel-file','uses'=>'Admin\DownloadController@downloadExcelFile'));
        //Route::get('download/', 'Admin\DownloadController@index')->name('admin.download.index');
        Route::get('/download', 'Admin\DownloadController@create')->name('admin.download.index');
        Route::post('/download/store', 'Admin\DownloadController@store')->name('admin-download-store');
    });
    ...
    Route::group(['middleware' => 'permissions:categories'], function () {
        ...
        Route::get('/set/datatables', 'Admin\SetController@datatables')->name('admin-set-datatables'); //JSON REQUEST
        Route::get('/set', 'Admin\SetController@index')->name('admin-set-index');
        Route::get('/set/create', 'Admin\SetController@create')->name('admin-set-create');
        Route::post('/set/create', 'Admin\SetController@store')->name('admin-set-store');
        Route::get('/set/edit/{id}', 'Admin\SetController@edit')->name('admin-set-edit');
        Route::post('/set/edit/{id}', 'Admin\SetController@update')->name('admin-set-update');
        Route::delete('/set/delete/{id}', 'Admin\SetController@destroy')->name('admin-set-delete');
        Route::get('/set/status/{id1}/{id2}', 'Admin\SetController@status')->name('admin-set-status');

        // SIZE SECTION ------------

        Route::get('/size/datatables', 'Admin\SizeController@datatables')->name('admin-size-datatables'); //JSON REQUEST
        Route::get('/size', 'Admin\SizeController@index')->name('admin-size-index');
        Route::get('/size/create', 'Admin\SizeController@create')->name('admin-size-create');
        Route::post('/size/create', 'Admin\SizeController@store')->name('admin-size-store');
        Route::get('/size/edit/{id}', 'Admin\SizeController@edit')->name('admin-size-edit');
        Route::post('/size/edit/{id}', 'Admin\SizeController@update')->name('admin-size-update');
        Route::delete('/size/delete/{id}', 'Admin\SizeController@destroy')->name('admin-size-delete');
        Route::get('/size/status/{id1}/{id2}', 'Admin\SizeController@status')->name('admin-size-status');

        // Color SECTION ------------

        Route::get('/color/datatables', 'Admin\ColorController@datatables')->name('admin-color-datatables'); //JSON REQUEST
        Route::get('/color', 'Admin\ColorController@index')->name('admin-color-index');
        Route::get('/color/create', 'Admin\ColorController@create')->name('admin-color-create');
        Route::post('/color/create', 'Admin\ColorController@store')->name('admin-color-store');
        Route::get('/color/edit/{id}', 'Admin\ColorController@edit')->name('admin-color-edit');
        Route::post('/color/edit/{id}', 'Admin\ColorController@update')->name('admin-color-update');
        Route::delete('/color/delete/{id}', 'Admin\ColorController@destroy')->name('admin-color-delete');
        Route::get('/color/status/{id1}/{id2}', 'Admin\ColorController@status')->name('admin-color-status');
    ...
    Route::group(['middleware' => 'permissions:home_page_settings'], function () {
        ...
        Route::get('/webpushnotification', 'Admin\WebpushnotificationController@index')->name('admin-webpushnotification-index');
        Route::get('/webpushnotification/create', 'Admin\WebpushnotificationController@create')->name('admin-webpushnotification-create');
        Route::post('/webpushnotification/create', 'Admin\WebpushnotificationController@store')->name('admin-webpushnotification-store');
        Route::delete('/webpushnotification/delete/{id}', 'Admin\WebpushnotificationController@destroy')->name('admin-webpushnotification-delete');

         // ------------ ADMIN REVIEW SECTION ------------

        Route::get('/review/datatables', 'Admin\ReviewController@datatables')->name('admin-review-datatables');
        ...
        Route::delete('/review/delete/{id}', 'Admin\ReviewController@destroy')->name('admin-review-delete');

        // ------------ ADMIN REVIEW SECTION ENDS ------------

        // ------------ ADMIN DEAL SECTION ------------

        Route::get('/deal/datatables', 'Admin\DealController@datatables')->name('admin-deal-datatables');
        Route::get('/deal', 'Admin\DealController@index')->name('admin-deal-index');
        Route::get('/deal/create', 'Admin\DealController@create')->name('admin-deal-create');
        Route::post('/deal/create', 'Admin\DealController@store')->name('admin-deal-store');
        Route::get('/deal/edit/{id}', 'Admin\DealController@edit')->name('admin-deal-edit');
        Route::post('/deal/edit/{id}', 'Admin\DealController@update')->name('admin-deal-update');
        Route::delete('/deal/delete/{id}', 'Admin\DealController@destroy')->name('admin-deal-delete');

        // ------------ ADMIN DEAL SECTION ENDS ------------
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::post('/order/review/submit', 'User\UserController@orderReviewSubmit')->name('front.order.review.submit');
        // User Review Ends

        // User Orders
        
        Route::post('/order/refund-specific/request-submit', 'User\OrderController@RefundSpecificProductFromOrderRequest')->name('order.refund-specific.request-submit');
        Route::post('/order/refund/request-submit', 'User\OrderController@completeOrderRefundRequest')->name('order.refund.request-submit');
    ...
    // Deal SECTION
    Route::get('/deals', 'Front\FrontendController@deals')->name('front.deals');
    // Deal SECTION ENDS

    //gifting route starts
    ...
    Route::post('/check-pincode-availability', 'Front\ProductDetailsController@checkPincodeAvailablity')->name('check.pincode.availability');
    // PRODCT SECTION ENDS
