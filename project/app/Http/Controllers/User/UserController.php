...
class UserController extends UserBaseController
{
    ...
    {
        $productId = $request->get('buttonProductID');
        $message = $request->get('productMessageVal');
        $ratingval = $request->get('productRatingVal');
        $userId = $request->get('productUserVal');
        $orderId = $request->get('productOrderIdVal');
        ...
        if ($rating->save()) {
            return response()->json(['status' => 'success', 'message' => 'Product rating saved successfully.']);
        } else {
