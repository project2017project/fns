...
! function(y, q, z) {
  function k(a) {
    return /youtu\.be/.test(a) ? a.split("youtu.be/")[1].split("?")[0].split("&")[0].split("#")[0] : /youtube\.com\/v\//.test(a) ? a.split("youtube.com/v/")[1].split("?")[0].split("&")[0].split("#")[0] : /youtube\.com\/embed\//.test(a) ? a.split("youtube.com/embed/")[1].split("?")[0].split("&")[0].split("#")[0] : /youtube.com|youtuberepeater.com|listenonrepeat.com/.test(a) ? a.split("v=")[1].split("&")[0].split("#")[0] : !1
  }
  ...
  function g(u, n, d) {
    ...
    function l() {
      A.stop().fadeOut("fast"), c.stop().fadeOut("fast", function() {
    ...
    var c = y(z.createElement("DIV")).addClass(u.cssClass).css(v),
      ...
      D = y(z.createElement("IFRAME")).addClass(u.cssClass + u.iframeCssClass).attr({
        src: j + d + r
      }).css(x);
    c.append(D).append(s), y("body").append(A).append(c), u.open && D.on("load", function() {
      a()
    }), null !== n && E(n), B(s.add(A)), w.on("resize", t).trigger("resize")
  }
  var w = y(q),
...
(function() {
  ...
  W = '<span class="odometer-value"></span>', aa = '<span class="odometer-ribbon"><span class="odometer-ribbon-inner">' + W + "</span></span>", ak = '<span class="odometer-digit"><span class="odometer-digit-spacer">8</span><span class="odometer-digit-inner">' + aa + "</span></span>", ah = '<span class="odometer-formatting-mark"></span>', al = "(,ddd).dd", ag = /^\(?([^)]*)\)?(?:(.)(d+))?$/, af = 30, ai = 2000, an = 20, ae = 2, aj = 0.5, ad = 1000 / af, am = 1000 / an, Z = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", I = document.createElement("div").style, Y = null != I.transition || null != I.webkitTransition || null != I.mozTransition || null != I.oTransition, K = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, ac = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, S = function(d) {
    ...
    if (!T && null != window.jQuery) {
      for (T = !0, i = ["html", "text"], h = [], f = 0, j = i.length; j > f; f++) {
        g = i[f], h.push(function(d) {
          var c;
          return c = window.jQuery.fn[d], window.jQuery.fn[d] = function(b) {
            var e;
    ...
    function b(z) {
      ...
      try {
        for (j = ["innerHTML", "innerText", "textContent"], t = 0, s = j.length; s > t; t++) {
          w = j[t], null != this.el[w] && ! function(c) {
    ...
    return b.prototype.renderInside = function() {
      ...
      if (null != ac) {
        try {
          return null == this.observer && (this.observer = new ac(function() {
            var c;
      ...
      var c;
      return "string" == typeof d && (d = d.replace(null != (c = this.format.radix) ? c : ".", "<radix>"), d = d.replace(/[.,]/g, ""), d = d.replace("<radix>", "."), d = parseFloat(d, 10) || 0), J(d, this.format.precision)
    }, b.prototype.bindTransitionEnd = function() {
      var i, h, n, m, l, k, j = this;
      if (!this.transitionEndBound) {
        for (this.transitionEndBound = !0, h = !1, l = Z.split(" "), k = [], n = 0, m = l.length; m > n; n++) {
          i = l[n], k.push(this.el.addEventListener(i, function() {
            return h ? !0 : (h = !0, setTimeout(function() {
      ...
      return k = p.slice(1, 4), m = k[0], n = k[1], c = k[2], o = (null != c ? c.length : void 0) || 0, this.format = {
        repeating: m,
        radix: n,
        precision: o
      }
      ...
      for (u.push("odometer"), Y || u.push("odometer-no-transitions"), u.push(t ? "odometer-theme-" + t : "odometer-auto-theme"), this.el.className = u.join(" "), this.ribbons = {}, this.digits = [], s = !this.format.precision || !Q(z) || !1, n = z.toString().split("").reverse(), q = 0, o = n.length; o > q; q++) {
        w = n[q], "." === w && (s = !0), this.addDigit(w, s)
      }
      return this.startWatchingMutations()
    }, b.prototype.update = function(e) {
      var d, f = this;
      return e = this.cleanValue(e), (d = e - this.value) ? (M(this.el, "odometer-animating-up odometer-animating-down odometer-animating"), d > 0 ? U(this.el, "odometer-animating-up") : U(this.el, "odometer-animating-down"), this.stopWatchingMutations(), this.animate(e), this.startWatchingMutations(), setTimeout(function() {
      ...
      var o, n, m, l, k, j = this;
      if (n = +i - this.value) {
        return l = m = O(), o = this.value, (k = function() {
          var d, c, a;
          return O() - l > j.options.duration ? (j.value = i, j.render(), void H(j.el, "odometerdone")) : (d = O() - m, d > am && (m = O(), a = d / j.options.duration, c = n * a, o += c, j.render(Math.round(o))), null != K ? K(k) : setTimeout(k, am))
        })()
      }
      ...
      if (at = this.value, aD = this.getFractionalDigitCount(at, aL), aD && (aL *= Math.pow(10, aD), at *= Math.pow(10, aD)), aI = aL - at) {
        ...
        for (this.resetDigits(), ar = aG.reverse(), aA = A = 0, e = ar.length; e > A; aA = ++A) {
          for (aB = ar[aA], this.digits[aA] || this.addDigit(" ", aA >= aD), null == (ao = this.ribbons)[aA] && (ao[aA] = this.digits[aA].querySelector(".odometer-ribbon-inner")), this.ribbons[aA].innerHTML = "", 0 > aI && (aB = aB.reverse()), ay = au = 0, av = aB.length; av > au; ay = ++au) {
            aC = aB[ay], aw = document.createElement("div"), aw.className = "odometer-value", aw.innerHTML = aC, this.ribbons[aA].appendChild(aw), ay === aB.length - 1 && U(aw, "odometer-last-value"), 0 === ay && U(aw, "odometer-first-value")
          }
        }
  ...
  }(), ab.options = null != (P = window.odometerOptions) ? P : {}, setTimeout(function() {
    var g, f, j, i, h;
    ...
    if (null != document.querySelectorAll) {
      for (g = document.querySelectorAll(ab.options.selector || ".odometer"), i = [], l = 0, k = g.length; k > l; l++) {
        h = g[l], i.push(h.odometer = new ab({
          el: h,
  ...
  }, null != (null != (N = document.documentElement) ? N.doScroll : void 0) && null != document.createEventObject ? (R = document.onreadystatechange, document.onreadystatechange = function() {
    ...
    return ab
  }) : typeof exports === !1 ? module.exports = ab : window.Odometer = ab
}).call(this);
...
! function(a, c, b) {
  a.fn.scrollUp = function(d) {
    ...
    var u, q, m, j, h, o, l, g = a.fn.scrollUp.settings = a.extend({}, a.fn.scrollUp.defaults, e),
      k = !1;
    switch (l = g.scrollTrigger ? a(g.scrollTrigger) : a("<a/>", {
        id: g.scrollName,
        href: "#top"
      }), g.scrollTitle && l.attr("title", g.scrollTitle), l.appendTo("body"), g.scrollImg || g.scrollTrigger || l.html(g.scrollText), l.css({
        display: "none",
        position: "fixed",
        zIndex: g.zIndex
      }), g.activeOverlay && a("<div/>", {
        id: g.scrollName + "-active"
      }).css({
        position: "absolute",
    ...
    j = "top" === g.scrollFrom ? g.scrollDistance : a(b).height() - a(c).height() - g.scrollDistance, h = a(c).scroll(function() {
      a(c).scrollTop() > j ? k || (l[u](m), k = !0) : k && (l[q](m), k = !1)
    }), g.scrollTarget ? "number" == typeof g.scrollTarget ? o = g.scrollTarget : "string" == typeof g.scrollTarget && (o = Math.floor(a(g.scrollTarget).offset().top)) : o = 0, l.click(function(d) {
      d.preventDefault(), a("html, body").animate({
        scrollTop: o
      }, g.scrollSpeed, g.easingType)
    })
