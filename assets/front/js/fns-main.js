...
(function ($) {
   ...
   cutleryvideo_slider();
    ...
    $(".shop-categoery ul.tabs li").on('click', function () {
        ...
        $('.shop-categoery .productSlider').slick('refresh');
        $('.shop-categoery .productSlider-style2').slick('refresh');
    });
    /* if in drawer mode */
    ...
    $(".popular-main-wrapper ul.tabs li").on('click', function () {
        ...
        $('.popular-main-wrapper .productSlider-style2').slick('refresh');
    });
    /* if in drawer mode */
    ...
    $('.popular-main-wrapper ul.tabs li').last().addClass("tab_last");
     ...
     /*-----------------------------------
     41. Tabs With Accordian Responsive
     -------------------------------------*/
    ...
    $(".lauch-wrapper ul.tabs li").on('click', function () {
        ...
        $('.lauch-wrapper .productSlider-style2').slick('refresh');
    });
    /* if in drawer mode */
